        ...
        <div className="flex items-center justify-center gap-10 mt-24 md:mt-40">
            ...
            <div className="bg-[#16181f] pt-10 pb-5 px-6 rounded-2xl flex flex-col gap-6 w-full sm:w-[80%] lg:w-[80%] xl:w-1/2 z-10">
                ...
                <div className="text-center">
                    <h2 className="text-4xl font-bold">Welcome to <span className="bg-[linear-gradient(180deg,_#3e75f3_50%,_#0b3db2_120%)] bg-clip-text text-transparent">Courso Instructors</span></h2>
                    <p className="text-gray-300">Share your knowledge. Inspire learners. Grow your impact</p>
                </div>
