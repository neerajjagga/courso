...
const LectureCard = ({ lecture, courseId }: PropType) => {
  const [isDropDownEnabled, setIsDropDownEnabled] = useState<boolean>(false);
  const [isDescriptionDialogOpened, setIsDescriptionDialogOpened] = useState<boolean>(false);
  const [isAddContentDialogOpened, setIsAddContentDialogOpened] = useState<boolean>(false);
          ...
          {!isDescriptionDialogOpened ? (
            ...
            <div className="flex flex-col gap-4">
              <DescriptionTextEditor
                ...
                initialDescription={lecture.description ?? undefined}
              />
