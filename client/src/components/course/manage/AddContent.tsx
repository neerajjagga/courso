...
interface PropType {
    setIsAddContentDialogOpened: React.Dispatch<React.SetStateAction<boolean>>;
    lectureId: string;
}

const AddContent = ({ setIsAddContentDialogOpened, lectureId }: PropType) => {
    const [contentType, setContentType] = useState<string>('');
    const [isContentTypeSelected, setIsContentTypeSelected] = useState<boolean>(false);
