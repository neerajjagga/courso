...
import { IUserCourseProgressDocument } from "../types/userCourseProgress.types";
...
const UserCourseProgress = mongoose.model<IUserCourseProgressDocument>('UserCourseProgress', userCourseProgressSchema);
