...
const sendVerificationEmail = async (recipientEmail: string, verificationCode: number) => {
    try {
...
const sendCourseReceipt = async (recipientEmail: string, courseName: string, purchaseDate: string, amount: number, courseImage: string) => {
    try {
        const transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
...
const sendPaymentFailedEmail = async (recipientEmail: string, courseName: string, purchaseDate: string, amount: number, reason: string, courseImage: string) => {
    try {
        const transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
...
export { sendVerificationEmail, sendCourseReceipt, sendPaymentFailedEmail }